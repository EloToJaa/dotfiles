...
attr.intensity = function(type) return { Attribute = { Intensity = type } } end
...
attr.underline = function(type) return { Attribute = { Underline = type } } end
...
function Cells:reset() self.segments = {} end
